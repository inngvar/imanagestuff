              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('descrption')}>
                    <Translate contentKey="imanagestuffApp.timeEntry.descrption">Descrption</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
              ...
              <tbody>
                {timeEntryList.map((timeEntry, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <TextFormat type="date" value={timeEntry.timestamp} format={APP_DATE_FORMAT} />
                    </td>
                    <td>{timeEntry.shotDescription}</td>
                    <td>{timeEntry.descrption}</td>
