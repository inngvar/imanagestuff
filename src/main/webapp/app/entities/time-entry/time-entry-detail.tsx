    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            <TextFormat value={timeEntryEntity.timestamp} type="date" format={APP_DATE_FORMAT} />
          </dd>
          <dt>
          ...
          <dt>
            <span id="descrption">
              <Translate contentKey="imanagestuffApp.timeEntry.descrption">Descrption</Translate>
            </span>
          </dt>
          <dd>{timeEntryEntity.descrption}</dd>
          <dt>
