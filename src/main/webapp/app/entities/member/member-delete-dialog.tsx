...
export const MemberDeleteDialog = (props: IMemberDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="imanagestuffApp.member.delete.question">
        <Translate contentKey="imanagestuffApp.member.delete.question" interpolate={{ id: memberEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-member" color="danger" onClick={confirmDelete}>
