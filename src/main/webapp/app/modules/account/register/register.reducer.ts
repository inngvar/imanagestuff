...
// Actions
export const handleRegister = (login, firstName, middleName, lastName, email, password, langKey = 'en') => ({
  type: ACTION_TYPES.CREATE_ACCOUNT,
  payload: axios.post('api/register', { login, firstName, middleName, lastName, email, password, langKey }),
  meta: {
