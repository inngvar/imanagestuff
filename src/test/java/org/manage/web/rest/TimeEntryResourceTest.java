...
public class TimeEntryResourceTest {
    ...
    public static TimeEntry createEntity() {
        ...
        timeEntry.descrption = DEFAULT_DESCRPTION;
        return timeEntry;
    }
    ...
    public void createTimeEntry() {
        ...
        assertThat(testTimeEntry.descrption).isEqualTo(DEFAULT_DESCRPTION);
    }
    ...
    public void updateTimeEntry() {
        ...
        updatedTimeEntry.descrption = UPDATED_DESCRPTION;
        ...
        assertThat(testTimeEntry.descrption).isEqualTo(UPDATED_DESCRPTION);
    }
    ...
    public void getAllTimeEntries() {
        ...
        given()
            ...
            .body("duration", hasItem(DEFAULT_DURATION.toString()))            .body("timestamp", hasItem(TestUtil.formatDateTime(DEFAULT_TIMESTAMP)))            .body("shotDescription", hasItem(DEFAULT_SHOT_DESCRIPTION))            .body("descrption", hasItem(DEFAULT_DESCRPTION));
    }
