...
- **Задача 1.3: Компонент парсинга сообщений**
  ...
  - Реализовать поддержку форматов:
    - `Ч:ММ Описание` (длительность)
    - `Ч:ММ-Ч:ММ Описание` (интервал)
...
- **Задача 4.3: Пользовательский интерфейс (React)**
  - Добавить в настройки профиля или на главную страницу секцию "Telegram Bot".
  - Реализовать вызов API для получения кода привязки и отображение инструкции.

## Группа 5: Стабилизация

- **Задача 5.1: Конфигурация и финальное тестирование**
  - Добавить все необходимые ключи в `application.properties`.
