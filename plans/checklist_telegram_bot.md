...
- [x] **3.3 REST-ресурс для генерации ссылок**
  - [x] Создать эндпоинт `POST /api/telegram/generate-link`
  - [x] Логика формирования Deep Link
...
- [x] **4.3 Пользовательский интерфейс (React)**
  - [x] Добавить секцию Telegram в настройки
  - [x] Интеграция с API `generate-link`
  - [x] Отображение кнопки перехода в Telegram и срока действия
